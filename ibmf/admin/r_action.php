   ...
   <?php foreach ($road as $user): 
      if($user['action']!=0)
         ...
         ?>
          <div class="blog-card">
    <div class="meta">
      <div class="photo" style="text-align: center;"><img src="<?php echo 'upload/' . $user['image'] ?>" width="90" height="90" alt="can't display"></div>
    </div>
...
if(isset($_POST['delete_pressed']))
{
            ...
            $sql = "DELETE FROM road WHERE name='abcdefgh'";
