        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Road complaint</h2>
                </div>
                <div class="card-body">
...
<div class="form-row">
		<div class="name">Image of the road</div>
        <div class="value">
...
$sql = "INSERT INTO road (name, mobile, location,image)
VALUES ('".$_POST["stu_name"]."','".$_POST["stu_email"]."','".$_POST["stu_city"]."','$image')";
